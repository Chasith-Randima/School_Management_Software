...
int nHeightEllipse // width of ellipse
        ...
        private void AllStudents_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt.Clear();
                da.Fill(dt);
                dataGridAllStudents.RowTemplate.Height = 75;
                dataGridAllStudents.DataSource = dt;
                DataGridViewImageColumn pic1 = new DataGridViewImageColumn();
                pic1 = (DataGridViewImageColumn)dataGridAllStudents.Columns[5];
        ...
        private void dataGridAllStudents_Click(object sender, EventArgs e)
        {
            string stuIndex = dataGridAllStudents.CurrentRow.Cells[3].Value.ToString();

            SearchOne oneStue = new SearchOne();
            oneStue.studentindex = stuIndex;
            oneStue.Show();
            this.Hide();
