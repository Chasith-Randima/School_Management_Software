...
(
    ...
    int nHeightEllipse // width of ellipse 
        ...
        {
            UpdateOneStudent oneStuUp = new UpdateOneStudent();
            oneStuUp.studentIndex = studentIndex.Text;
            oneStuUp.Show();
            this.Hide();
        }
        ...
        {
            UpdateOneStaff oneStaffUp = new UpdateOneStaff();
            oneStaffUp.staffNumber = staffIndex.Text;
            oneStaffUp.Show();
            this.Hide();
        }
